...
# 8) PREPARE FEATURES - MINIMAL SET TO AVOID LEAKAGE
# ==============================================================================
print("\n🔍 FEATURE PREPARATION - MINIMAL SAFE SET")
print("-" * 50)

# Only use clearly safe features
feature_columns = [
    # Temporal (safe)
...
# 9) CLEAN DATA - REMOVE ROWS WITH MISSING CRITICAL FEATURES
# ==============================================================================
...
# 10) MODEL TRAINING - SIMPLE AND CLEAN
# ==============================================================================
print("\n🤖 MODEL TRAINING")
print("-" * 50)
...
print(f"\n" + "="*60)
print("📈 FINAL RESULTS - NO DATA LEAKAGE GUARANTEED")
print("="*60)
...
ward_agg.to_csv('ward_predictions_no_leakage_final.csv', index=False)
importance_df.to_csv('feature_importance_no_leakage_final.csv', index=False)

print(f"\n🎉 ANALYSIS COMPLETE - ZERO DATA LEAKAGE")
